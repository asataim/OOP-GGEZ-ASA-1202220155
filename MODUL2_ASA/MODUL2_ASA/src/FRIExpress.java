public class FRIExpress extends Ekspedisi
{
    ...
    public void informasi() {
        if (pecahBelah == true) {
            System.out.println("Ekspedisi FRIExpress dengan jumlah cabang "+ jumlahCabang+" dan berpusat di "+pusat+" mempunyai tarif sebesar Rp."+tarif+".0 perkilogram. Selain itu, ekspedisi ini melayani paket pecah belah");
            
        }
        else{
            System.out.println("Ekspedisi FRIExpress dengan jumlah cabang "+ jumlahCabang+" dan berpusat di "+pusat+" mempunyai tarif sebesar Rp."+tarif+".0 perkilogram. Selain itu, ekspedisi ini tidak melayani paket pecah belah");
